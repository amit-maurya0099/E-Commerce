...
const {createProduct, getAllProducts, updateProductById, deleteProductById, getProductDetail, createProductReview, getAllReviewsByProductId, deleteReview, getAdminProducts} = require("../controllers/product-controller");
