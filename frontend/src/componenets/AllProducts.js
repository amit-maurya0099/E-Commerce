...
const isAuthenticated=useSelector((store)=>store.users.isAuthenticated)
  ...
  return (
    < >
      ...
      <div className='p-8 w-[15%]  sticky top-0 left-0  border-r border-gray-400 bg-[#e1c9dd] '>
        ...
        <ul>
          {
            categories.map((category,index)=>(
              <li key={index} className='text-md text-purple-700 transition-all hover:text-white cursor-pointer' onClick={()=>
                {
