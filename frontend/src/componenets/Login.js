...
import { toggleSignUp, setIsAuthenticated, setLoading } from "../Utils/appSlices/userSlice";
...
const Login = () => {
  ...
  const handleFormSubmit = async (e) => {
    ...
    try {
      ...
      const response = await fetch("https://e-commerce-0ti2.onrender.com/api/user/login", {
        method: "POST",
        headers: {
