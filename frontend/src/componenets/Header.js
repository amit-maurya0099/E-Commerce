    ...
    <div className="sticky top-0 z-20">
      ...
      <header className="  flex justify-between shadow-lg py-2 text-white bg-[#5ecf95] ">
        ...
        <div className="flex items-center justify-end gap-12  w-[40%] px-4">
          ...
          <div>
            <button className="flex items-center  text-lg transition-all hover:text-white">
              Orders
            </button>
          </div>
          <div>
        ...
        {!isAuthenticated &&        
          ...
          {isAuthenticated && (user && user.avatar) ?( <div onClick={handleProfileClick} className="cursor-pointer">
            ...
            </div>): <FaUserCircle className="size-8 cursor-pointer" onClick={()=>toast.error("please sign in")} />}
